...
public class ExerciseService {
    ...
    private static void populateGradeExerciseSubtypeMapping() {
        ...
        GRADE_EXERCISE_SUB_TYPE_MAP.put(Grade.SECOND, List.of(ADDITION, SUBTRACTION, DOUBLING, HALVING, THREESTEPADDITION, THREESTEPSUBTRACTION, MULTIPLICATION, MULTIPLICATIONTABLE, DIVISION));
        GRADE_EXERCISE_SUB_TYPE_MAP.put(Grade.THIRD, List.of(ADDITION, SUBTRACTION, MULTIPLICATION, DIVISION, ROUNDINGTEN, LONGADDITION, LONGSUBTRACTION, LONGMULTIPLICATION, ORDEROFOPERATIONS));
        GRADE_EXERCISE_SUB_TYPE_MAP.put(Grade.FOURTH, List.of(ADDITION, SUBTRACTION, MULTIPLICATION, DIVISION));
        GRADE_EXERCISE_SUB_TYPE_MAP.put(Grade.FIFTH, List.of(ADDITION, SUBTRACTION, MULTIPLICATION, DIVISION));
        GRADE_EXERCISE_SUB_TYPE_MAP.put(Grade.SIXTH, List.of(ADDITION, SUBTRACTION, MULTIPLICATION, DIVISION));
